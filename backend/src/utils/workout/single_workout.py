...
class single_workout:
    ...
    def __init__(self, trio: tuple, reps: list, pace: list, distance: int):
        ...
        Args:
            trio (tuple): ``(stim, rpe, dist)`` tuple describing the workout.
            reps (list): List of repetition distances.
            pace (list): Pace description strings.
            distance (int): Percentage of the long run distance.
        """
        self.trio = trio
        self.reps = reps
        self.pace = pace
    ...
    def get_trio(self) -> tuple:
        ...
        Returns:
            tuple: ``(stim, rpe, dist)`` for this workout.
        """
        return self.trio
