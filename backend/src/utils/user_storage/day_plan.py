...
class day_plan:
    ...
    def __make_stimuli_trio(workouts: list) -> tuple:
        ...
        Args:
            workouts (list): List of workout trios.

        Returns:
            tuple: Trio representing the maximum stimulus, maximum RPE and total
    ...
    def add_workouts(self, *workouts) -> None:
        ...
        Args:
            *workouts (tuple): Workout trios to append.
        """
    ...
    def update__real_rpe(self, real_rpe: int) -> None:
        ...
        Args:
            real_rpe (int): Actual perceived effort.
        """
        self.real_rpe = real_rpe
    ...
    def __eq__(self, other) -> bool:
        ...
        Args:
            other (day_plan): Day plan to compare against.
